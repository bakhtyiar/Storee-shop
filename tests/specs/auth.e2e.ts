...
describe("Login process desktop", () => {
  beforeEach(async () => {
...
describe("Login process mobile portrait", () => {
  beforeEach(async () => {
    await setMobilePortraitScreenSize();
    await AuthPage.open();
    await AuthPage.showMenuMobile();
    await AuthPage.menuButtonMobile.waitForDisplayed();
...
describe("Register process dekstop", () => {
  beforeEach(async () => {
    await setDesktopScreenSize();
    await AuthPage.open();
    await AuthPage.showRegisterFormDesktop();
  })
...
describe("Register process mobile portrait", () => {
  beforeEach(async () => {
    await setMobilePortraitScreenSize();
    await AuthPage.open();
    await AuthPage.menuButtonMobile.waitForDisplayed();
    await AuthPage.showMenuMobile();
    await AuthPage.registerButtonMobile.waitForDisplayed();
    await AuthPage.showRegisterFormMobile();
  })
